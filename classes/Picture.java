...
public class Picture extends SimplePicture 
{
                 ...
                 int startRow, int startCol)
  {
    ...
    public void copy(Picture fromPic, int pieceRow, int pieceCol, int startRow, int startCol)
    {
        Pixel fromPixel = null;
        Pixel toPixel = null;
        Pixel[][] toPixels = this.getPixels2D();
        Pixel[][] fromPixels = fromPic.getPixels2D();
        for (int fromRow = 0, toRow = startRow; fromRow < pieceRow && toRow < pieceCol;
             fromRow++, toRow++)
        {
  ...
  public void createCollage()
  {
    ...
    public void createPartCollage()
    {
        Picture flower1 = new Picture("flower1.jpg");
        Picture flower2 = new Picture("flower2.jpg");
        this.copy(flower1, 100, 100, 0,0);
        this.copy(flower2, 100, 100, 100,0);
        this.copy(flower1,200,0);
        Picture flowerNoBlue = new Picture(flower2);
        flowerNoBlue.zeroBlue();
        this.copy(flowerNoBlue,300,0);
